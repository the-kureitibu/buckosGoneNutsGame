...
var pre_game: Array[Dictionary] = [
	...
	{"speaker": "Ami", "line": "Bucko, Bucko, Bucko, Bucko, Bucko, Bucko, Buckoo- Are?! ", "emotion": "happy"},
	{"speaker": "Ami", "line": "Nani kore?", "emotion": "monkas"},
	...
	{"speaker": "Ami", "line": "Neglected??!", "emotion": "annoyed"},
	{"speaker": "Elder1", "line": "...", "emotion": ""},
	{"speaker": "Elder2", "line": "...", "emotion": ""},
	{"speaker": "Elder3", "line": "...", "emotion": ""},
	{"speaker": "Ami", "line": "...", "emotion": "annoyed"},
	{"speaker": "Ami", "line": "You guys gone nuts?! Fine! Come get some!!", "emotion": "angry"},
...
var pre_wave_two: Array[Dictionary] = [
	...
	{"speaker": "Ami", "line": "You tryna kill me or something?!?", "emotion": "angry"}
]
...
var pre_wave_three: Array[Dictionary] = [
	...
	{"speaker": "Ami", "line": "Show me what you got bucko.", "emotion": "angry"}
]
...
var true_end: Array[Dictionary] = [
	{"speaker": "Ami", "line": "You spoiled brats all you want are chus!! You silly buckos! ", "emotion": "angry"},
...
var bad_end: Array[Dictionary] = [
	...
	{"speaker": "Ami", "line": "No buckos… NOOOOOOOO!!!!", "emotion": "annoyed"}
]

var good_end: Array[Dictionary] = [
	{"speaker": "Ami", "line": "Hmmp!", "emotion": "angry"},
